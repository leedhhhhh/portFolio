...
<body>
	...
	%>
	<form name="form" action="AccountAction.jsp" method="post">
	<%
		}
	%>
				  ...
				  <fieldset>
					  ...
					  <div class="form-group">
					   ...
					   <div class="form-group">
					    ...
					    <input type="text" name="message" name="map" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="원하시는 배송메시지를 입력해주세요.">
					  </div>
					</fieldset>
					<br><br>
					<ul class="nav nav-tabs">
					  <li><a href="PaymentPage.jsp" style="color: black">신용카드</a></li>  
					  <li class="active"><a href="AccountPage.jsp" style="color: black">무통장입금</a></li>
					</ul>
					<br>
					<div class="form-group">
				      <label for="exampleSelect1" class="form-label mt-4">은행</label><br>
					...
					<div class="form-group">
					  	<label for="exampleInputEmail1" class="form-label mt-4"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">계좌번호</font></font></label>
					    <input name="accountNum" type="text"class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="계좌번호">
					...
					<div class="form-group">
					  	<label for="exampleInputEmail1" class="form-label mt-4"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">계좌비밀번호</font></font></label>
					    <input type="password" name="accoundPw" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="계좌비밀번호">
					</div>
