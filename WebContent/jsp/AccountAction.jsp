...
<body>
	...
	if(request.getParameter("accountPw") != null){
		accountPw = request.getParameter("accountPw");
	}
	...
	if(name.equals("")||map.equals("")||phnum.equals("")||message.equals("")||accountNum.equals("")||accountPw.equals("")||bank[i].equals("")){
		PrintWriter script = response.getWriter();
		script.println("<script>");
		...
		PrintWriter script = response.getWriter();
		script.println("<script>");
		script.println("alert('무통장 입금 결제가 완료되었습니다.')");
